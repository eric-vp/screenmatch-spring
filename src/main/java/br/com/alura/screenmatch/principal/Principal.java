...
public class Principal {
    ...
    private final String API_KEY = "&apikey=c55615aa";
...
//        List<Serie> seriesPersonalizada = repositorio.findByTotalTemporadasLessThanEqualAndAvaliacaoGreaterThanEqual(numeroTemporadas, avaliacaoMinima);
        List<Serie> seriesPersonalizada = repositorio.seriesPorTemporadaEAvaliacao(numeroTemporadas, avaliacaoMinima);
        System.out.println("*** Séries filtradas ***");
        seriesPersonalizada.forEach(s ->
                System.out.println(s.getTitulo() + " - temporadas: " + s.getTotalTemporadas() + " - avaliação: " + s.getAvaliacao()));
    }

    private void buscarEpisodioPorTrecho() {
        System.out.println("Qual é o nome do episódio para busca?");
    ...
    private void buscarEpisodiosPorData() {
        ...
        if(serieBusca.isPresent()){
            ...
            List<Episodio> episodiosAno = repositorio.episodioPorAno(serie, anoLancamento);
